/******************************************************************************
 * This vertex shader implements lighting calculations.
 * It receives three matrices (projection-view, model, and normal) and computes
 * world-space position and world-space normal vectors for the fragment shader.
 *
 * Happy hacking! - eric
 *****************************************************************************/
...
void main()
{
    ...
    // Set object color to vertex color
    objectColor = vertexColor;
    
    // Calculate texture coordinates based on face orientation
    if (face == 0.0)
    {
    ...
    // First transform world-space position by projection-view matrix
